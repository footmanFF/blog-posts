...
- ThreadLocalRandom.getProbe() 获取的是啥？ThreadLocalRandom.advanceProbe(h) 又是啥？[JAVA THREADLOCALRANDOM EXPLAINED](http://alvaro-videla.com/2016/10/inside-java-s-threadlocalrandom.html)https://en.wikipedia.org/wiki/Xorshift
